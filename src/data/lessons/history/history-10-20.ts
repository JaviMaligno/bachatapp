...
**Dance explosion:** At the same time, Florida-based duo **Ataca y La Alemana** uploaded simple yet magnetic [partnerwork videos](https://www.youtube.com/watch?v=2cehkSxOLNA) that racked up tens of millions of views, turning social-media virality into sold-out international workshops.`,
    ...
    {
      id: 'new-styles-virality',
      title: '2016-2019: Social-Media Virality & the Birth of New Styles',
      contentBlocks: [
        {
...
> **Curiosity:** Many Latin-dance congresses now schedule three separate rooms—Dominican, Sensual/Moderna, and Fusion—so DJs can tailor energy without genre-switching whiplash, reflecting the diversification of the dance.`,
    ...
    },
    {
      ...
      title: '2019-2025: Global Recognition & Record Numbers',
      contentBlocks: [
        {
          content: `- **UNESCO** declared "Music and Dance of Dominican Bachata" an Intangible Cultural Heritage of Humanity in December 2019, legitimising the genre at home and abroad.
- **Romeo Santos' Formula Vol. 3 Tour** (2023) sold one million tickets and grossed $106 million—9th highest Latin tour in Billboard Boxscore history.
...
| Younger Dominican acts (e.g., **El Chaval**, **Joe Veras**) combine old-school storytelling with slick videos to stay visible. | International stars (e.g., Romeo, Turizo, Rosalía) use bachata tracks as album "color," boosting genre cachet while remaining pop-focused. |`
        }
      ]
    },
    {
    ...
    {
      id: 'key-dancers',
      title: 'Dancers Who Shaped the Conversation',
      contentBlocks: [
        {
