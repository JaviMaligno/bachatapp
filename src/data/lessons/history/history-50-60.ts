...
export const musicHistory5060Lesson: MusicLesson = {
  id: 'history-50-60',
  type: 'history',
  ...
  sections: [
    ...
    },
    {
      ...
      content3: 'Learn more about the core instruments in bachata in the [Musical Instruments Lesson](/section/music/lesson/instruments).',
      sections: [
        {
          id: 'influences',
